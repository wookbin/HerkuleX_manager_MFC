...
*/
	// !!! 아래 ReCreateGraph() 함수는 OnTimer() 함수 내에 있던 것임.
	ReCreateGraph();
...
int COScopeCtrl::ReCreateGraph()
{
	...
	if (pointToDraw > m_nPlotWidth / m_nShiftPixels + 10)
		pointToDraw = m_nPlotWidth / m_nShiftPixels + 10;
